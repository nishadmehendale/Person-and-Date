...
public class Person {
	...
	public void display() {
		...
		difference = dob.age();
		System.out
				.println("Age: " + difference[2] + " Years, " + difference[1] + " Months, " + difference[0] + " Days ");
	}
	...
	public void olderOne(Person p) {
		...
		if (dob.isSmaller(p.dob)) {
			...
			System.out.println(p.name + "is older than " + this.name + " by " + +difference[2] + " Years, "
					+ difference[1] + " Months, " + difference[0] + " Days ");
		} else {
			difference = p.dob.diff(dob);
			System.out.println(this.name + "is older than " + p.name + " by " + +difference[2] + " Years, "
					+ difference[1] + " Months, " + difference[0] + " Days ");
		}
	}
}
